...
class GoodsOutDetailScreen extends StatelessWidget {
  final int transactionId;

  const GoodsOutDetailScreen(this.transactionId, {super.key});
  ...
  Widget build(BuildContext context) {
    ...
    try {
      final transaction = goodsOutProvider.findById(transactionId);
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: const Text('Kembali ke Barang Keluar'),
                ),
              ),
            ],
          ),
